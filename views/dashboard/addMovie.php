...
<body>
    <div class="dashcontainer">
        ...
        <div class="main">       <!-- related with style.css file  -->
            <h1>Add New Movie</h1>
            <div class="include">
                <form action="" method="post" class="sign-in-form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="right">
                            ...
                            <div class="input-field">     <!-- director name filed-->
                                <i class="fas fa-user"></i>
                    ...
                    <div class="row">
                        <div class="left">
                            ...
                            <div class="input-field" id="input-field-password">   <!-- file choosing  -->
                                <i class="fas fa-lock"></i>
    ...
    <script src="../js/dashboard_addmovie.js"> </script>
</body>
