...
<body>
    <div class="dashcontainer"> <!-- related with dashboard.css-->
        <?php include '../inc/sidebar.php' ?>
        <div class="main">
            <h1>Movie View </h1>
            <div class="include m-4">
                <table class="table text-white ">
                    <thead>  <!-- table headers in a row -->
                        <tr>
                            <th scope="col">Release Date</th>   <!-- scope specifies table header for columns -->
                    ...
                    <tbody>
                        <?php foreach($movieList as $key=>$value): //var_dump($value); ?> <!-- iterating over elements of array-->

                        <tr> <!-- updating table rows-->
                      ...
                      <?php endforeach; ?>   <!-- close foreachloop-->
